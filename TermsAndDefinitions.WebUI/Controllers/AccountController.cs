...
namespace TermsAndDefinitions.WebUI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var person = db.Users.FirstOrDefault(u => u.UserName == model.UserName || u.Email == model.UserName);
            if (ModelState.IsValid && person != null && WebSecurity.Login(person.UserName, model.Password, persistCookie: model.RememberMe))
            {
